...
### review-agent
- Path: C:\Users\eduar\.codex\skills\.system\review-agent\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
...
No project-specific AGENTS.md, CLAUDE.md, .cursorrules, GEMINI.md, or copilot-instructions.md files were found.
